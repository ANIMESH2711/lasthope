 ...
 * @package        	CodeIgniter
 * @category    	Libraries
 * @originalauthor  Phil Sturgeon, Chris Kacerguis
...
abstract class REST_Controller extends CI_Controller
{
    ...
    */
     ...
     * @param bool $continue
     */
    public function response($data = null, $http_code = null, $continue = false,$base_nodexml=null)
    {
        global $CFG;
...
//print_r($data);
                ...
                $output = $this->format->factory($data)->{'to_'.$this->response->format}($data,null,$base_nodexml);
            }
