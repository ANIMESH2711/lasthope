...
<article class="card-body mx-auto" style="max-width: 400px;">
	...
	<h4 class="card-title mt-3 text-center">मदद करने के लिए यहाँ रजिस्टर करे ।<br> Register if u want to help . </</h4>
...
<div class="form-group input-group">
  ...
  <div class="form-group input-group">
    ...
    <input name="role" type="text" value="2"   class="form-control" placeholder="Email address " hidden>
