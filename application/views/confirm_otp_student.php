...
<article class="card-body mx-auto" style="max-width: 400px;">
	<h4 class="card-title mt-3 text-center">Parent / Student Registration</h4>
	<!-- <p class="text-center">Get started with your free account</p> -->
	<p>
  <script src='https://kit.fontawesome.com/a076d05399.js' crossorigin='anonymous'></script>

  <form method="post" class="form-horizontal form-material" id="loginform" action="<?=base_url('Student/confirm_otp_process');?>">
  ...
  <div class="form-group input-group" >
    	...
    	<input name="phone" class="form-control" minlength="10" value="<?=$phone; ?>" maxlength="10" placeholder="Phone number" type="text" required>
    </div>
    ...
    <div class="form-group input-group" >
    	...
    	<input name="otp" class="form-control" placeholder="Phone number" type="text" required>
    </div>
...
<form method="post" class="form-horizontal form-material" id="loginform" action="<?=base_url('User/signUpTeacher');?>">
	<div class="form-group input-group">
		<div class="input-group-prepend">
    ...
    <div class="form-group input-group">
    	<div class="input-group-prepend">
		    <span class="input-group-text"> <i class="fa fa-envelope"> Login Id</i> </span>
		 </div>
    ...
    <div class="form-group input-group">
    	...
    	<input name="phone" class="form-control" minlength="10"  maxlength="10" placeholder="Phone number" type="text">
    </div> <!-- form-group// -->
    <div class="form-group input-group">
    	<div class="input-group-prepend">
    ...
    <div class="form-group">
    <div id="submit11" style="display:none">
