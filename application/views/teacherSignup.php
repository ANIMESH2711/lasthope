...
<article class="card-body mx-auto" style="max-width: 400px;">
	<h4 class="card-title mt-3 text-center">Get Corona Help in this Pandemic after Registration .</h4>
	<!-- <p class="text-center">Get started with your free account</p> -->
	<p>
  <script src='https://kit.fontawesome.com/a076d05399.js' crossorigin='anonymous'></script>

  <form method="post" class="form-horizontal form-material" id="loginform" action="<?=base_url('User/confirm_otp');?>">
