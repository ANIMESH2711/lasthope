		...
		<nav class="navbar top-navbar navbar-expand-md navbar-light">
			...
			<div class="navbar-collapse">
				...
				<ul class="navbar-nav mr-auto mt-md-0">
					<!-- This is  -->
					<div style="all:initial"><meta name="viewport" content="width=device-width, initial-scale=1">
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
					<li class="nav-item"> <a class="nav-link nav-toggler hidden-md-up text-muted waves-effect waves-dark" href="javascript:void(0)"><i class="mdi mdi-menu" style="font-size:36px"></i></a> </li>
					</div>
					<li class="nav-item m-l-10"> <a class="nav-link sidebartoggler hidden-sm-down text-muted waves-effect waves-dark" href="javascript:void(0)"><i class="fa fa-bars" style="font-size:36px"></i></i></a> </li>
					<!-- ============================================================== -->
							...
							<ul class="dropdown-user">
								<li>
									<div class="dw-user-box">
										...
										<div class="u-text">
											<h4><?=$_SESSION['name'];?></h4>
											<p class="text-muted"></p><?=$_SESSION['email'];?>
	...
	<aside class="left-sidebar">
		...
		<div class="scroll-sidebar">
			...
			<nav class="sidebar-nav">
				...
				<li><a href="<?=base_url('u1/addRequest');?>">Tell us your requirement . </a></li>
				<li><a href="<?=base_url('u1/dashboard/');?>">Old requirement status</a></li>
