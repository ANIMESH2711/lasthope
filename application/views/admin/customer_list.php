...
<div class="page-wrapper">
	...
	<div class="row page-titles">
		...
		<div class="col-md-5 align-self-center">
			...
			<h3 class="text-themecolor">Machine List</h3>
		...
		<div class="col-md-7 align-self-center">
			...
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item">Machine List</li>
...
<a href="<?=base_url('Admin/addCustomer/');?>" class="btn btn-block btn-lg btn-danger col-4">Add</a>
</div>
							...
							<table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
...

								{
									...
									<tr>
										...
										<!-- <td><a  class="btn btn-primary" href="<?=base_url('Admin/EditFaculty/'.$r->mid);?>">
